      ...
      <DialogContent className="sm:max-w-[85vw] w-[85vw] h-[90vh] flex flex-col p-0 gap-0 overflow-hidden bg-white border-none shadow-lg">
        ...
        <div className="flex-1 flex flex-col p-6 gap-6 overflow-hidden bg-white">
          <div className="flex flex-col gap-2 shrink-0">
             ...
             <div className="rounded-lg bg-white border border-neutral-200 shadow-sm h-[180px] overflow-y-auto">
             ...
             <div className="flex-[0.6] flex flex-col gap-4 overflow-hidden border border-neutral-200 rounded-lg bg-white shadow-sm p-4">
                <div className="flex items-center justify-between border-b border-neutral-100 pb-2">
                  ...
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-lg font-black text-blue-600">{currentTotalSelected.toFixed(3)}</span>
                  </div>
                </div>
                
                <div className="flex gap-2 justify-end mb-2">
                  <Button size="sm" variant="ghost" onClick={() => handleMoveToAvailable()} className="text-red-500 hover:text-red-600 text-[10px] font-black uppercase">Remove All</Button>
