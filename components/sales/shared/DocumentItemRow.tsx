...
useEffect(() => {
  ...
  if (isService) {
    // Service mein Quantity / Price nahi hoti.
    // LineTotal hi service ka base amount hai.
    const serviceAmount =
    ...
    const updatedLine = {
      ...
      // Service tax + freight tax
      TaxAmount: taxTotal,
      TaxTotal: taxTotal,

      GrossTotal: grossTotal,

      // User entered LineTotal ko overwrite nahi karna
      LineTotal: serviceAmount,
    };

    // IMPORTANT:
    // UI ke draft ko bhi update karo
    setDraftLine(updatedLine);

    // Store/footer ko bhi update karo
    updateLine(
      line.ItemCode,
      updatedLine
    );
